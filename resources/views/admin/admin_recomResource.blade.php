...
@section('content')
		...
		<form class="layui-form">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input class="layui-input" name="sLinkAddress" id="sLinkAddress" lay-verify="url" autocomplete="off" placeholder="请输入资源地址！">
				</div>
				<label class="layui-form-label">资源名称：</label>
				<div class="layui-input-inline">
					<input class="layui-input" name="sLinkName" id="sLinkName" lay-verify="required" autocomplete="off" placeholder="请输入资源名称！">
				</div>
				<label class="layui-form-label" style="padding-left:10px;width: 100px; ">资源图片地址：</label>
				<div class="layui-input-inline">
					<input class="layui-input" name="sLinkImg" id="sLinkImg" lay-verify="url" autocomplete="off" placeholder="请输入资源图片地址！">
				</div>
	...
	layui.use(['jquery'], function(){ 
	  ...
	  $(function(){
	  	...
	  	$("#extend dl dd").eq(1).addClass("layui-this");
	  }); 
	});
	...
	layui.use('table', function(){
		...
		var tableIns = table.render({
			...
			,{field:'sLinkID', title: '资源ID', width:251, sort: true, fixed: true}
			,{field:'sLinkName', title: '资源名称', width:240}
